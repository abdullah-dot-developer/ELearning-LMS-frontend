...
const CourseDetails: FC<Props> = ({
  ...
  const discountPercentage =
    ((data?.courseEstimatedPrice - data?.coursePrice) /
      ...
      <div className="w-[90%] 800px:w-[90%] py-5 m-auto font-Poppins">
        <div className="w-full flex flex-col-reverse 800px:flex-row">
          <div className="w-full 800px:w-[65%] 800px:pr-5">
            ...
            <h1 className="text-[25px] font-Poppins font-[600] text-black dark:text-white">
              What should you know before enrolling in the course?
            </h1>
            <div>
              ...
              <br />
              <div className="w-full">
                <div className="800px:flex items-center flex-col">
                  <Ratings rating={data?.ratings} />
