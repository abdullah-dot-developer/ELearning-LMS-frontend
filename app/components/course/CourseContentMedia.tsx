...
const CourseContentMedia: FC<Props> = ({
  ...
  useEffect(() => {
    ...
    if (answerSuccess) {
      setAnswer("");
      refetch();
      toast.success("Answer Added sussessfully!");
      if (user.role !== "admin") {
        socketId.emit("notification", {
                ...
                (item: any, index: number) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {user.role === "admin" && item.replies.length === 0 && (
                        <span
                      ...
                      {isReviewReply && reviewId === item._id && (
                        <div className="w-full flex relative">
                          ...
                          <button
                            type="submit"
                            className="absolute right-0 bottom-1 border border-blue-500 px-2 py-1 rounded-md"
                      ...
                      {item.replies?.length > 0 &&
                        item?.replies?.map((i: any, index: number) => (
                          <div
                          ...
                          >
                            ...
                            <div className="pl-2">
                              ...
                              <small className="text-[#ffffff83]">
                                {timeAgo.format(new Date(i.createdAt))} •
                              </small>
                            </div>
                          </div>
                        ))}
          ...
          <>
            ...
            <>
              <div className="w-full flex relative dark:text-white text-black">
                ...
                <button
                  type="submit"
                  className="absolute right-0 bottom-1 border-2 border-[#2190FF] py-1 px-2 cursor-pointer rounded-md"
