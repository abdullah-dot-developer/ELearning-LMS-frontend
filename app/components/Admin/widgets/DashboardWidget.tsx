  ...
  return (
    <div className="mt-[30px] min-h-screen">
          ...
          <div className="w-full dark:bg-[#111C43] rounded-sm shadow mb-2">
            <div className="flex items-center p-5 justify-between">
              <div className="">
                ...
                <h5 className="py-2 font-Poppins dark:text-[#45CBA0] text-black font-[400] text-[20px]">
                  Sales Obtained
                </h5>
              </div>
              <div>
      ...
      <div className="grid grid-cols-[65%,35%] mt-[-20px]">
        ...
        <div className="m-5">
          <h5 className="dark:text-white w-full text-black text-center text-[20px] font-[400] font-Poppins pb-3">
            Recent Transaction
          </h5>
